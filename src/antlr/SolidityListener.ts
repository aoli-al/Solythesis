...
import { StandardDefinitionContext } from "./SolidityParser";
import { ConstraintContext } from "./SolidityParser";
...
import { ForAllExpressionContext } from "./SolidityParser";
import { SumExpressionContext } from "./SolidityParser";
...
export interface SolidityListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `SolidityParser.standardDefinition`.
	 * @param ctx the parse tree
	 */
	enterStandardDefinition?: (ctx: StandardDefinitionContext) => void;
	/**
	 * Exit a parse tree produced by `SolidityParser.standardDefinition`.
	 * @param ctx the parse tree
	 */
	exitStandardDefinition?: (ctx: StandardDefinitionContext) => void;

	/**
	 * Enter a parse tree produced by `SolidityParser.constraint`.
	 * @param ctx the parse tree
	 */
	enterConstraint?: (ctx: ConstraintContext) => void;
	/**
	 * Exit a parse tree produced by `SolidityParser.constraint`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by `SolidityParser.forAllExpression`.
	 * @param ctx the parse tree
	 */
	enterForAllExpression?: (ctx: ForAllExpressionContext) => void;
	/**
	 * Exit a parse tree produced by `SolidityParser.forAllExpression`.
	 * @param ctx the parse tree
	 */
	exitForAllExpression?: (ctx: ForAllExpressionContext) => void;

	/**
	 * Enter a parse tree produced by `SolidityParser.sumExpression`.
	 * @param ctx the parse tree
	 */
	enterSumExpression?: (ctx: SumExpressionContext) => void;
	/**
	 * Exit a parse tree produced by `SolidityParser.sumExpression`.
	 * @param ctx the parse tree
	 */
	exitSumExpression?: (ctx: SumExpressionContext) => void;
