...
export interface SolidityVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by `SolidityParser.standardDefinition`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitStandardDefinition?: (ctx: StandardDefinitionContext) => Result;

	/**
	 * Visit a parse tree produced by `SolidityParser.constraint`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by `SolidityParser.forAllExpression`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitForAllExpression?: (ctx: ForAllExpressionContext) => Result;

	/**
	 * Visit a parse tree produced by `SolidityParser.sumExpression`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitSumExpression?: (ctx: SumExpressionContext) => Result;
