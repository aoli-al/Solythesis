...
contract StandardToken is SafeMath {
  ...
  function transfer (address _to, uint256 _value) public returns (bool success) {
    if (balances[msg.sender] >= _value && _value > 0) {
      {
        {
          uint256 tmp_1 = balances[msg.sender] = balances[msg.sender];
      ...
      {
        {
          uint256 tmp_2 = balances[_to] = balances[_to];
          sum_0 -= balances[_to];
          balances[_to] = _value;
          sum_0 += balances[_to];
          balances[_to] = tmp_2;
  ...
  function transferFrom (address _from, address _to, uint256 _value) public returns (bool success) {
    if (balances[_from] >= _value && allowed[_from][msg.sender] >= _value && _value > 0) {
      {
        {
          uint256 tmp_3 = balances[_to] = balances[_to];
          sum_0 -= balances[_to];
          balances[_to] = _value;
          sum_0 += balances[_to];
          balances[_to] = tmp_3;
      ...
      {
        {
          uint256 tmp_4 = balances[_from] = balances[_from];
  ...
  constructor (
    ...
    uint256 _fundingEndBlock) public {
      ...
      {
        {
          uint256 tmp_5 = balances[batFundDeposit] = balances[batFundDeposit];
    ...
    function createTokens () external payable {
      ...
      {
        {
          uint256 tmp_6 = balances[msg.sender] = balances[msg.sender];
          sum_0 -= balances[msg.sender];
