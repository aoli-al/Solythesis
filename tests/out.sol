    ...
    {
      {
        ...
        sum_0 = sum_0.sub(balances[_to]);
        balances[_to] = balances[_to].add(_value);
        sum_0 = sum_0.add(balances[_to]);
        balances[_to] = tmp_2;
      }
      balances[_to] = balances[_to].add(_value);
    }
...
contract StandardToken is ERC20, BasicToken {
  ...
  function transferFrom (address _from, address _to, uint256 _value) public returns (bool) {
    ...
    {
      {
        uint256 tmp_3 = balances[_from];
        sum_0 -= balances[_from];
        balances[_from] = balances[_from].sub(_value);
        sum_0 += balances[_from];
        balances[_from] = tmp_3;
      }
      balances[_from] = balances[_from].sub(_value);
    }
    {
      {
        uint256 tmp_4 = balances[_to];
        sum_0 -= balances[_to];
        balances[_to] = balances[_to].add(_value);
        sum_0 += balances[_to];
        balances[_to] = tmp_4;
    ...
    {
      {
        ...
        sum_0 = sum_0.sub(balances[msg.sender]);
        balances[msg.sender] = balances[msg.sender].sub(amount);
        sum_0 = sum_0.add(balances[msg.sender]);
      ...
      {
        {
          ...
          sum_0 = sum_0.sub(balances[_receivers[i]]);
          balances[_receivers[i]] = balances[_receivers[i]].add(_value);
          sum_0 = sum_0.add(balances[_receivers[i]]);
...
contract BecToken is PausableToken {
  ...
  constructor () public {
    ...
    {
      {
        uint256 tmp_7 = balances[msg.sender];
        sum_0 -= balances[msg.sender];
        balances[msg.sender] = totalSupply;
        sum_0 += balances[msg.sender];
        balances[msg.sender] = tmp_7;
      }
      balances[msg.sender] = totalSupply;
    }
    {
