...
for (uint256 index_43 = 0; index_43 < a_store_4.length; index_43 += 1) {
sum_tokenCount += _ownedTokensCount[a_store_4[index_43]];
assert(sum_tokenCount >= _ownedTokensCount[a_store_4[index_43]]);
}
...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_44 = 0; index_44 < b_store_6.length; index_44 += 1) {
sum_ownersToken[b_store_6[index_44]] = 0;
}

for (uint256 index_45 = 0; index_45 < a_store_8.length; index_45 += 1) {
sum_ownersToken[_tokenOwner[a_store_8[index_45]]] += 1;
assert(sum_ownersToken[_tokenOwner[a_store_8[index_45]]] >= 1);
}
...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_50 = 0; index_50 < b_store_6.length; index_50 += 1) {
sum_ownersToken[b_store_6[index_50]] = 0;
}

for (uint256 index_51 = 0; index_51 < a_store_8.length; index_51 += 1) {
sum_ownersToken[_tokenOwner[a_store_8[index_51]]] += 1;
assert(sum_ownersToken[_tokenOwner[a_store_8[index_51]]] >= 1);
}

}

for (uint256 index_54 = 0; index_54 < a_store_10.length; index_54 += 1) {
assert(_ownedTokensCount[a_store_10[index_54]] == sum_ownersToken[a_store_10[index_54]]);
}
