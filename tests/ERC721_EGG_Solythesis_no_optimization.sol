...
{
for (uint256 index_105 = 0; index_105 < a.length; index_105 += 1) {
assert(ownedTokensCount[a[index_105]] == sum_ownersToken[a[index_105]]);
}
...
assert(sum_tokenCount == allTokens.length);
{
for (uint256 index_107 = 0; index_107 < a.length; index_107 += 1) {
assert(ownedTokensCount[a[index_107]] == sum_ownersToken[a[index_107]]);
}
...
assert(sum_tokenCount == allTokens.length);
{
for (uint256 index_109 = 0; index_109 < a.length; index_109 += 1) {
assert(ownedTokensCount[a[index_109]] == sum_ownersToken[a[index_109]]);
}
...
uint256 tmp_sum_tokenCount_112 = sum_tokenCount;
...
assert(tmp_sum_tokenCount_112 >= ownedTokensCount[_to]);
tmp_sum_tokenCount_112 -= ownedTokensCount[_to];
}
...
sum_tokenCount = tmp_sum_tokenCount_112;
}
...
assert(tmp_sum_tokenCount_113 >= ownedTokensCount[_from]);
tmp_sum_tokenCount_113 -= ownedTokensCount[_from];
}
...
assert(sum_tokenCount == allTokens.length);
{
for (uint256 index_117 = 0; index_117 < a.length; index_117 += 1) {
assert(ownedTokensCount[a[index_117]] == sum_ownersToken[a[index_117]]);
}
...
assert(sum_tokenCount == allTokens.length);
{
for (uint256 index_119 = 0; index_119 < a.length; index_119 += 1) {
assert(ownedTokensCount[a[index_119]] == sum_ownersToken[a[index_119]]);
}
