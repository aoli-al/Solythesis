...
uint256 tmp_sum_tokenCount_147 = sum_tokenCount;
...
assert(tmp_sum_tokenCount_147 >= _ownedTokensCount[to]);
tmp_sum_tokenCount_147 -= _ownedTokensCount[to];
}
...
sum_tokenCount = tmp_sum_tokenCount_147;
}
