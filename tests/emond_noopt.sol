...
assert(tmp_sum_tokenCount_70 >= ownerToNFTokenCount[_from]);
tmp_sum_tokenCount_70 -= ownerToNFTokenCount[_from];
}
...
require(idToOwner[_tokenId] == address(0));
{
if (idToOwner[_tokenId] == idToOwner[_tokenId] && idToOwner[_tokenId] != 0x0000000000000000000000000000000000000000) {
assert(sum_ownersToken[idToOwner[_tokenId]] >= 1);
{
a.push(idToOwner[_tokenId]);
}
sum_ownersToken[idToOwner[_tokenId]] -= 1;
}
...
assert(tmp_sum_tokenCount_75 >= ownerToNFTokenCount[_to]);
tmp_sum_tokenCount_75 -= ownerToNFTokenCount[_to];
}
...
{
for (uint256 index_77 = 0; index_77 < a.length; index_77 += 1) {
assert(ownerToNFTokenCount[a[index_77]] == sum_ownersToken[a[index_77]]);
}
...
assert(sum_tokenCount == tokens.length);
{
for (uint256 index_79 = 0; index_79 < a.length; index_79 += 1) {
assert(ownerToNFTokenCount[a[index_79]] == sum_ownersToken[a[index_79]]);
}
...
assert(sum_tokenCount == tokens.length);
{
for (uint256 index_81 = 0; index_81 < a.length; index_81 += 1) {
assert(ownerToNFTokenCount[a[index_81]] == sum_ownersToken[a[index_81]]);
}
