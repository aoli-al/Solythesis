...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_148 = 0; index_148 < a.length; index_148 += 1) {
assert(_ownedTokensCount[a[index_148]] == sum_ownersToken[a[index_148]]);
}
...
uint256 tmp_sum_tokenCount_153 = sum_tokenCount;
...
assert(tmp_sum_tokenCount_153 >= _ownedTokensCount[to]);
tmp_sum_tokenCount_153 -= _ownedTokensCount[to];
}
...
sum_tokenCount = tmp_sum_tokenCount_153;
}
...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_158 = 0; index_158 < a.length; index_158 += 1) {
assert(_ownedTokensCount[a[index_158]] == sum_ownersToken[a[index_158]]);
}
...
assert(_ownedTokensCount[a[index_161]] == sum_ownersToken[a[index_161]]);
}
