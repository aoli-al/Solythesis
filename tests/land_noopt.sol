...
assert(_ownedTokensCount[a[index_129]] == sum_ownersToken[a[index_129]]);
}
...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_131 = 0; index_131 < a.length; index_131 += 1) {
assert(_ownedTokensCount[a[index_131]] == sum_ownersToken[a[index_131]]);
}
...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_133 = 0; index_133 < a.length; index_133 += 1) {
assert(_ownedTokensCount[a[index_133]] == sum_ownersToken[a[index_133]]);
}
...
uint256 tmp_sum_tokenCount_136 = sum_tokenCount;
...
assert(tmp_sum_tokenCount_136 >= _ownedTokensCount[to]);
tmp_sum_tokenCount_136 -= _ownedTokensCount[to];
}
...
sum_tokenCount = tmp_sum_tokenCount_136;
}
...
assert(tmp_sum_tokenCount_137 >= _ownedTokensCount[from]);
tmp_sum_tokenCount_137 -= _ownedTokensCount[from];
}
...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_143 = 0; index_143 < a.length; index_143 += 1) {
assert(_ownedTokensCount[a[index_143]] == sum_ownersToken[a[index_143]]);
}
...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_146 = 0; index_146 < a.length; index_146 += 1) {
assert(_ownedTokensCount[a[index_146]] == sum_ownersToken[a[index_146]]);
}
