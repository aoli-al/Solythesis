...
contract Upgradable is Controllable {
    ...
    function setInternalDependencies(address[] memory _newDependencies) public onlyOwner {
    ...
    function setExternalDependencies(address[] memory _newDependencies) public onlyOwner {
...
contract EggStorage is ERC721Token {
    ...
    function push(address _sender, uint256[2] memory _parents, uint8 _dragonType) public onlyController returns (uint256 id) {
