...
{
for (uint256 index_91 = 0; index_91 < a.length; index_91 += 1) {
assert(ownedTokensCount[a[index_91]] == sum_ownersToken[a[index_91]]);
}
...
assert(sum_tokenCount == allTokens.length);
{
for (uint256 index_93 = 0; index_93 < a.length; index_93 += 1) {
assert(ownedTokensCount[a[index_93]] == sum_ownersToken[a[index_93]]);
}
...
assert(sum_tokenCount == allTokens.length);
{
for (uint256 index_95 = 0; index_95 < a.length; index_95 += 1) {
assert(ownedTokensCount[a[index_95]] == sum_ownersToken[a[index_95]]);
}
...
uint256 tmp_sum_tokenCount_98 = sum_tokenCount;
...
assert(tmp_sum_tokenCount_98 >= ownedTokensCount[_to]);
tmp_sum_tokenCount_98 -= ownedTokensCount[_to];
}
...
sum_tokenCount = tmp_sum_tokenCount_98;
}

function removeTokenFrom (address _from, uint256 _tokenId) internal {
uint256 tmp_sum_tokenCount_99 = sum_tokenCount;
require(ownerOf(_tokenId) == _from);
{
if (_from != 0x0000000000000000000000000000000000000000) {
assert(tmp_sum_tokenCount_99 >= ownedTokensCount[_from]);
tmp_sum_tokenCount_99 -= ownedTokensCount[_from];
}
...
sum_tokenCount = tmp_sum_tokenCount_99;
}
...
assert(sum_tokenCount == allTokens.length);
{
for (uint256 index_103 = 0; index_103 < a.length; index_103 += 1) {
assert(ownedTokensCount[a[index_103]] == sum_ownersToken[a[index_103]]);
}
