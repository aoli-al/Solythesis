...
assembly {
tmp_91 := mload(0x40)
mstore(0x40, add(tmp_91, 640))
sstore(memoryStart_0_slot, tmp_91)
mstore(add(tmp_91, 0), 0)
}
...
{
for (uint256 index_90 = 0; index_90 < a.length; index_90 += 1) {
assert(ownedTokensCount[a[index_90]] == sum_ownersToken[a[index_90]]);
}
...
assert(sum_tokenCount == allTokens.length);
{
for (uint256 index_96 = 0; index_96 < a.length; index_96 += 1) {
assert(ownedTokensCount[a[index_96]] == sum_ownersToken[a[index_96]]);
}
