...
{
for (uint256 index_201 = 0; index_201 < a.length; index_201 += 1) {
assert(_ownedTokensCount[a[index_201]] == sum_ownersToken[a[index_201]]);
}
...
uint256 tmp_sum_tokenCount_210 = sum_tokenCount;
...
assert(tmp_sum_tokenCount_210 >= _ownedTokensCount[to]);
tmp_sum_tokenCount_210 -= _ownedTokensCount[to];
}
...
sum_tokenCount = tmp_sum_tokenCount_210;
}
...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_217 = 0; index_217 < a.length; index_217 += 1) {
assert(_ownedTokensCount[a[index_217]] == sum_ownersToken[a[index_217]]);
}
...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_220 = 0; index_220 < a.length; index_220 += 1) {
assert(_ownedTokensCount[a[index_220]] == sum_ownersToken[a[index_220]]);
}
...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_223 = 0; index_223 < a.length; index_223 += 1) {
assert(_ownedTokensCount[a[index_223]] == sum_ownersToken[a[index_223]]);
}
