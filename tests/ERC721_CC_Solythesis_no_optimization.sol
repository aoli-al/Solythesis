...
assert(ownedTokensCount[a[index_77]] == sum_ownersToken[a[index_77]]);
}
...
assert(ownedTokensCount[a[index_79]] == sum_ownersToken[a[index_79]]);
}
...
assert(ownedTokensCount[a[index_81]] == sum_ownersToken[a[index_81]]);
}
...
uint256 tmp_sum_tokenCount_84 = sum_tokenCount;
...
assert(tmp_sum_tokenCount_84 >= ownedTokensCount[_to]);
tmp_sum_tokenCount_84 -= ownedTokensCount[_to];
}
...
sum_tokenCount = tmp_sum_tokenCount_84;
}

function removeTokenFrom (address _from, uint256 _tokenId) internal {
uint256 tmp_sum_tokenCount_85 = sum_tokenCount;
require(ownerOf(_tokenId) == _from);
{
if (_from != 0x0000000000000000000000000000000000000000) {
assert(tmp_sum_tokenCount_85 >= ownedTokensCount[_from]);
tmp_sum_tokenCount_85 -= ownedTokensCount[_from];
}
...
sum_tokenCount = tmp_sum_tokenCount_85;
}
