...
assembly {
tmp_76 := mload(0x40)
mstore(0x40, add(tmp_76, 640))
sstore(memoryStart_0_slot, tmp_76)
mstore(add(tmp_76, 0), 0)
}
...
address[] memory a_73;
assembly {
a_73 := add(sload(memoryStart_0_slot), 0)
}
...
for (uint256 index_74 = 0; index_74 < a_73.length; index_74 += 1) {
address tmp_75;
assembly {
tmp_75 := mload(add(a_73, mul(add(index_74, 1), 32)))
}

assert(ownedTokensCount[tmp_75] == sum_ownersToken[tmp_75]);
}
...
assembly {
tmp_80 := mload(0x40)
mstore(0x40, add(tmp_80, 640))
sstore(memoryStart_0_slot, tmp_80)
mstore(add(tmp_80, 0), 0)
}
...
address[] memory a_77;
assembly {
a_77 := add(sload(memoryStart_0_slot), 0)
}

safeTransferFrom(_from, _to, _tokenId, "");
if (entry_1 == 1) {
assert(sum_tokenCount == allTokens.length);
for (uint256 index_78 = 0; index_78 < a_77.length; index_78 += 1) {
address tmp_79;
assembly {
tmp_79 := mload(add(a_77, mul(add(index_78, 1), 32)))
}

assert(ownedTokensCount[tmp_79] == sum_ownersToken[tmp_79]);
}
...
assembly {
tmp_84 := mload(0x40)
mstore(0x40, add(tmp_84, 640))
sstore(memoryStart_0_slot, tmp_84)
mstore(add(tmp_84, 0), 0)
}
...
address[] memory a_81;
assembly {
a_81 := add(sload(memoryStart_0_slot), 0)
}
...
if (entry_1 == 1) {
assert(sum_tokenCount == allTokens.length);
for (uint256 index_82 = 0; index_82 < a_81.length; index_82 += 1) {
address tmp_83;
assembly {
tmp_83 := mload(add(a_81, mul(add(index_82, 1), 32)))
}
...
address[] memory a_86;
assembly {
a_86 := add(sload(memoryStart_0_slot), 0)
}

require(tokenOwner[_tokenId] == address(0));
{
address opt_85 = tokenOwner[_tokenId];
{
if (opt_85 == opt_85 && opt_85 != 0x0000000000000000000000000000000000000000) {
assert(sum_ownersToken[opt_85] >= 1);
{
address tmp_87 = opt_85;
assembly {
let tmp := add(mload(a_86), 1)
mstore(a_86, tmp)
mstore(add(a_86, mul(tmp, 32)), tmp_87)
}
...
if (opt_85 == opt_85 && opt_85 != 0x0000000000000000000000000000000000000000) {
{
address tmp_88 = opt_85;
assembly {
let tmp := add(mload(a_86), 1)
mstore(a_86, tmp)
mstore(add(a_86, mul(tmp, 32)), tmp_88)
}
...
tokenOwner[_tokenId] = opt_85;
}

{
uint256 opt_90 = ownedTokensCount[_to];
{
if (_to != 0x0000000000000000000000000000000000000000) {
assert(sum_tokenCount >= opt_90);
sum_tokenCount -= opt_90;
}
...
let tmp := add(mload(a_86), 1)
mstore(a_86, tmp)
mstore(add(a_86, mul(tmp, 32)), tmp_89)
}
...
address[] memory a_92;
assembly {
a_92 := add(sload(memoryStart_0_slot), 0)
}

require(ownerOf(_tokenId) == _from);
{
uint256 opt_94 = ownedTokensCount[_from];
{
if (_from != 0x0000000000000000000000000000000000000000) {
assert(sum_tokenCount >= opt_94);
sum_tokenCount -= opt_94;
}

}

{
address tmp_93 = _from;
assembly {
let tmp := add(mload(a_92), 1)
mstore(a_92, tmp)
mstore(add(a_92, mul(tmp, 32)), tmp_93)
}
...
ownedTokensCount[_from] = opt_94;
}

{
address opt_96 = tokenOwner[_tokenId];
{
if (opt_96 == opt_96 && opt_96 != 0x0000000000000000000000000000000000000000) {
assert(sum_ownersToken[opt_96] >= 1);
{
address tmp_97 = opt_96;
assembly {
let tmp := add(mload(a_92), 1)
mstore(a_92, tmp)
mstore(add(a_92, mul(tmp, 32)), tmp_97)
}
...
if (opt_96 == opt_96 && opt_96 != 0x0000000000000000000000000000000000000000) {
{
address tmp_98 = opt_96;
assembly {
let tmp := add(mload(a_92), 1)
mstore(a_92, tmp)
mstore(add(a_92, mul(tmp, 32)), tmp_98)
}
...
assert(ownedTokensCount[tmp_101] == sum_ownersToken[tmp_101]);
}
...
assembly {
tmp_106 := mload(0x40)
mstore(0x40, add(tmp_106, 640))
sstore(memoryStart_0_slot, tmp_106)
mstore(add(tmp_106, 0), 0)
}
...
assembly {
a_103 := add(sload(memoryStart_0_slot), 0)
}

super._mint(_tokenOwner, _tokenId);
if (entry_1 == 1) {
assert(sum_tokenCount == allTokens.length);
for (uint256 index_104 = 0; index_104 < a_103.length; index_104 += 1) {
address tmp_105;
assembly {
tmp_105 := mload(add(a_103, mul(add(index_104, 1), 32)))
}

assert(ownedTokensCount[tmp_105] == sum_ownersToken[tmp_105]);
}
