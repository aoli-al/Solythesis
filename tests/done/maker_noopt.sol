...
{
if (true) {
assert(tmp_sum_balance_45 >= _balances[msg.sender]);
tmp_sum_balance_45 -= _balances[msg.sender];
}
...
depth_0 += 1;
uint256 tmp_sum_balance_46 = sum_balance;
if (src != msg.sender) {
...
{
if (true) {
assert(tmp_sum_balance_46 >= _balances[src]);
tmp_sum_balance_46 -= _balances[src];
}
...
{
if (true) {
assert(tmp_sum_balance_46 >= _balances[dst]);
tmp_sum_balance_46 -= _balances[dst];
}
...
depth_0 -= 1;
if (depth_0 == 0) {
assert(_supply == tmp_sum_balance_46);
}

sum_balance = tmp_sum_balance_46;
return true;
}
...
depth_0 += 1;
uint256 tmp_sum_balance_47 = sum_balance;
...
{
if (true) {
assert(tmp_sum_balance_47 >= _balances[src]);
tmp_sum_balance_47 -= _balances[src];
}
...
{
if (true) {
assert(tmp_sum_balance_47 >= _balances[dst]);
tmp_sum_balance_47 -= _balances[dst];
}
...
depth_0 -= 1;
if (depth_0 == 0) {
assert(_supply == tmp_sum_balance_47);
}

sum_balance = tmp_sum_balance_47;
return true;
}
...
{
if (true) {
assert(tmp_sum_balance_48 >= _balances[guy]);
tmp_sum_balance_48 -= _balances[guy];
}
...
depth_0 -= 1;
if (depth_0 == 0) {
assert(_supply == tmp_sum_balance_48);
}
...
{
if (true) {
assert(tmp_sum_balance_49 >= _balances[guy]);
tmp_sum_balance_49 -= _balances[guy];
}
...
depth_0 -= 1;
if (depth_0 == 0) {
assert(_supply == tmp_sum_balance_49);
}
