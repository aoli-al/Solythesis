...
depth_0 -= 1;
if (depth_0 == 0) {
for (uint256 index_10 = 0; index_10 < x.length; index_10 += 1) {
assert(y[index_10] == 0 || sum_votes[x[index_10]][y[index_10]] == weightedVoteCounts[x[index_10]][y[index_10]]);
}
...
depth_0 -= 1;
if (depth_0 == 0) {
for (uint256 index_16 = 0; index_16 < x.length; index_16 += 1) {
assert(y[index_16] == 0 || sum_votes[x[index_16]][y[index_16]] == weightedVoteCounts[x[index_16]][y[index_16]]);
}
...
depth_0 -= 1;
if (depth_0 == 0) {
for (uint256 index_17 = 0; index_17 < x.length; index_17 += 1) {
assert(y[index_17] == 0 || sum_votes[x[index_17]][y[index_17]] == weightedVoteCounts[x[index_17]][y[index_17]]);
}
