...
def test_2(args):
    ...
    try:
        ...
        print(e)
    fetch_files(receiver_client, "/home/leo/results", "/u/choi/data/test2_{}_{}".format(contract, csv))
    receiver_client.close()
    clean_up(receiver)
...
def test_3(args):
    ...
    [receiver, receiver_client] = create_receiver_singleton("ami-0e05c3ca6e6db9733")
    print(contract+csv + ": " + receiver.public_ip_address)
    print("IP: " + receiver.public_ip_address)
    try:
        move_files(receiver_client, "/u/choi/data/test2_{0}_{1}/{0}-{1}-mainchain.bin".format(contract, csv), "/home/leo")
        execute_remote_command(receiver_client,
        ...
        print(e)
    fetch_files(receiver_client, "/home/leo/parity.log", "/u/choi/data/test3/parity-noopt-{}-{}-{}-{}.log".format(contract, csv, IOPS, INSTANCE))
