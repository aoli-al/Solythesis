...
assert(sum_tokenCount == _allTokens.length);
{
for (uint256 index_175 = 0; index_175 < a.length; index_175 += 1) {
assert(_ownedTokensCount[a[index_175]] == sum_ownersToken[a[index_175]]);
}
...
uint256 tmp_sum_tokenCount_178 = sum_tokenCount;
...
assert(tmp_sum_tokenCount_178 >= _ownedTokensCount[to]);
tmp_sum_tokenCount_178 -= _ownedTokensCount[to];
}
...
sum_tokenCount = tmp_sum_tokenCount_178;
}

function _removeTokenFrom (address from, uint256 tokenId) internal {
uint256 tmp_sum_tokenCount_179 = sum_tokenCount;
require(ownerOf(tokenId) == from);
{
if (from != 0x0000000000000000000000000000000000000000) {
assert(tmp_sum_tokenCount_179 >= _ownedTokensCount[from]);
tmp_sum_tokenCount_179 -= _ownedTokensCount[from];
}
...
sum_tokenCount = tmp_sum_tokenCount_179;
}
...
assert(_ownedTokensCount[a[index_191]] == sum_ownersToken[a[index_191]]);
}
...
assert(_ownedTokensCount[a[index_194]] == sum_ownersToken[a[index_194]]);
}
...
assert(_ownedTokensCount[a[index_197]] == sum_ownersToken[a[index_197]]);
}
